...
<body>
        ...
        <div class="main">
            ...
            <div class="menu">
                <ul>
                    <li><a href="indexAgendar.php">HOME</a></li>
...
<h1 id="ft">
        ...
        <section class="cards">
          ...
          <p>Podologista técnica Senac pelo Instituto Santo André ,Em constante atualização e modernização,
          a NOME DA CLINICA oferece equipamentos e procedimentos modernos, buscando inovação e melhoria 
  ...
  <a href="Agendamento.php" class="atencao">Massagem clássica</a>
  <br>
  <br>
...
<div class="figuras" style="width: 18rem;">
  ...
  <div class="card-body">
  <a href="Agendamento.php" class="atencao">Podoprofilaxia</a>
  <br>
  <br>
...
<div class="figuras" style="width: 18rem;">
  ...
  <div class="card-body">
  <a href="Agendamento.php" class="atencao">Onicocriptose com e sem infecção</a><br>
  <br>
  <br>
...
<div class="figuras" style="width: 18rem;">
  ...
  <div class="card-body">
  <a href="Agendamento.php" class="atencao">Tratamento com ortese</a>
  <br>
  <br>
 ...
 <div class="figuras" style="width: 18rem;">
  ...
  <div class="card-body">
  <a href="Agendamento.php"class="atencao">Tratamento de onicomicose/micose/fungo </a>
  <br>
  <br>
    <p class="card-text">tratamento com limpeza completa das unhas para retirada de maceração da unha causado pelo fungo aplicação de fitoterapico (antimicotico) e aplicação de ozônio ou laser parar inibir proliferação/ manifestação dessa micose para outras unhas e  deixar as unhas saudáveis.…</p><br>
        ...
        <br>	
        <div class="mapa">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3653.4942629123047!2d-46.595596685019615!3d-23.694037384617168!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce4478786f33ab%3A0xad8b99f665949c80!2sR.%20Ant%C3%B4nio%20de%20Almeida%20Soares%2C%2032%20-%20Vila%20Nogueira%2C%20Diadema%20-%20SP%2C%2009960-230!5e0!3m2!1spt-BR!2sbr!4v1677446786016!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>        </div>
      <div class="contact-section">
        <div class="contact-info">
          
          <div><i class="fa-solid fa-location-dot"></i>Localização</div>
          <div><i class="fas fa-map-marker-alt"></i>Rua Antônio de Almeida Soares, &nbsp;&nbsp;Nº 32 Vila Nogueira, Diadema - SP</div>
