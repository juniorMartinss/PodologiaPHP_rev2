...
<div class="container">
        ...
        <div class="col">
            ...
            <a href="telaAdm.php">HOME</a></li>
                <div class="form-group row">
                    <label class="col-sm-9 col-form-label">Formulario:</label>
                    <div class="col-sm-3">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Nome do Pasciente</th>
  ...
  <tbody>
    <?php
        while($user_data=mysqli_fetch_assoc($result))
        {
            ...
            echo "<td>".$user_data['data_agendamento']."</td>";
            echo "<td>".$user_data['hora_agendamento']."</td>";
